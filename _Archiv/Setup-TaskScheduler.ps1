...
try {
    ...
    Register-ScheduledTask -TaskName "Status Web App" -InputObject $Task1 -Force
    ...
    Register-ScheduledTask -TaskName "Stock Monitoring Service" -InputObject $Task2 -Force
    ...
    Register-ScheduledTask -TaskName "DSL Speedtest Monitoring" -InputObject $Task3 -Force
    ...
    Get-ScheduledTask -TaskName "Status Web App", "Stock Monitoring Service", "DSL Speedtest Monitoring" | Select-Object TaskName, State, @{Name="NextRunTime";Expression={$_.NextRunTime}} | Format-Table -AutoSize
...
Write-Host "`nTask setup completed. Press any key to exit..." -ForegroundColor Green
